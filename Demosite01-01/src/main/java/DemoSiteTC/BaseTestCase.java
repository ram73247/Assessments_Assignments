...
public class BaseTestCase {
	...
	protected void setDriverFunc(DriverFunc driverfunc) {
	...
	public void beforesuit() {
		...
		System.out.println("end of before suite");
	...
	public void beforeTest() {
		...
		Homepage = new HomePagePF(s.getDriver());
		AddUser = new AddUserPF(s.getDriver());
